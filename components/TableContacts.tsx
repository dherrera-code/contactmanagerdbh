...
import { getContacts } from '@/lib/contacts-services'
...
const TableContacts = () => {
    ...
    useEffect(() => {
        const getAllContacts = async () => {
            const data: ContactInfo[] = await getContacts(getToken());
            console.log(data);
                                            ...
                                            <TableRow key={idx} className='bg-white'>
                                                ...
                                                <TableCell>
                                                    <div className='flex place-items-center gap-2'>
                                                        <span onClick={handleUpdateModal} className='edit-icon hover:cursor-pointer'><svg className='' width="14" height="14" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <div onClick={handleDelete} className='bg-red-600 hover:bg-red-800 w-6 h-6 rounded-sm hover:cursor-pointer'></div>
                                                    </div>
                                                </TableCell>
                                            </TableRow>
                                    ))
