...
const FormComponent = () => {
    ...
    const [isRememberMe, setIsRememberMe] = useState<boolean | null>(false);
    ...
    const handleSubmit = async () => {
        ...
        if(token != null){
            if(typeof window != null ){
                if(isRememberMe) localStorage.setItem("token", token.token);
                push("/Dashboard");
            } else {
              ...
              <form className="flex max-w-md flex-col gap-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input onChange={(e) => setPassword(e.target.value)} type="text" id="text" className="block w-100 h-10 p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="alex.morgan@design.com" required />
                  </div>
                </div>
